...
def main():
    ...
    while count <= 100:
        ...
        batch_error_a,batch_inner_product1_a,batch_inner_product2_a,_,_ = get_feature_deletion_results(Input_dimension = N,Output_dimension = M,array1=norm_arr_1,array2=norm_arr_2,mapping_scheme=6,max_value=alpha)
        ...
        batch_error_b,batch_inner_product1_b,batch_inner_product2_b,_,_ = get_feature_deletion_results(Input_dimension = N,Output_dimension = M,array1=norm_arr_1,array2=norm_arr_2,mapping_scheme=8,max_value=alpha)
    ...
    plt.plot(range(len(avg_batch_error_a)), avg_batch_error_a, label = "Error With 1 step Compensation")
    plt.plot(range(len(avg_inner_product1_a)), avg_inner_product1_a, label = "IP1 With 1 step Compensation")
    plt.plot(range(len(avg_inner_product2_a)), avg_inner_product2_a, label = "IP2 With 1 step Compensation")

    plt.plot(range(len(avg_batch_error_b)), avg_batch_error_b, label = "Error With 2 step Compensation")
    plt.plot(range(len(avg_inner_product1_b)), avg_inner_product1_b, label = "IP1 With 2 step Compensation")
    plt.plot(range(len(avg_inner_product2_b)), avg_inner_product2_b, label = "IP2 With 2 step Compensation")
    plt.legend()

    #plt.show()
    plt.savefig('enron_plot_b.png')
